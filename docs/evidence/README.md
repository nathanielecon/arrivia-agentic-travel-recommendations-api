...
| Definitions and media repair | [local validation](raw/final-certification/definitions-media-repair-validation.md) | 165/165 frames, repaired physical rows, exact 165-second streams, D5 design / E6 proof definitions; fresh exact-candidate review pending |
